...
export default function UltraExtraButton(props: UltraExtraProps) {
    ...
    return (
        <button className={`${inter.className} relative w-max inline-flex items-center justify-center p-4 h-36 min-w-[270px] overflow-hidden text-xl tracking-tighter text-white bg-gray-800 rounded-lg group`}>
